...
const InfoCircle = (props) => (
    <div className='info-icon-wrapper' onClick={props.toggleShowInfoModal}>
        <svg id="Info_circled" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className='info-icon'>
...
export default connect(null, mapDispatchToProps)(InfoCircle)